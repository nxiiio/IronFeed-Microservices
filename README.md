...
| OpenAPI `users-ms` | `http://localhost:8080/v3/api-docs/users` |
| OpenAPI `workout-ms` | `http://localhost:8080/v3/api-docs/workout` |
| OpenAPI `social-ms` | `http://localhost:8080/v3/api-docs/social` |
| OpenAPI `posts-ms` | `http://localhost:8080/v3/api-docs/posts` |
